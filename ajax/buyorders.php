...
$sql = "SELECT * FROM buy_orderbook WHERE want='".$BTC."' and trade_id='".$my_coins->getTradeId()."' and trade_with = '".$BTCRYX."' and processed='1'";
$result = mysql_query($sql);
$count = mysql_num_rows($result);
if($count!=0) {
   $Query = mysql_query("SELECT amount, rate FROM buy_orderbook WHERE want='".$BTC."' and trade_id='".$my_coins->getTradeId()."' and processed='1' and trade_with = '".$BTCRYX."' ORDER BY rate DESC");
   ...
   echo '<table>
         <tr>
            <td colspan="3" align="left" style="font-weight: bold; padding: 2px;" nowrap>Buy Orders</td>
                  ...
                  <td colspan="3" align="right" style="padding: 2px;" nowrap>Total '.$BTC.': '.$btevalue.'</td>
               </tr><tr>

<?php
error_reporting(0);
$sql = "SELECT * FROM ordersfilled WHERE want='".$my_coins->coins_names_prefix[1]."' and trade_id='".$my_coins->getTradeId()."' and processed='1' ORDER BY rate DESC";
...
if($count!=0) {
   echo '<table>
            <tr>
               ...
               <td align="left" style="font-weight: bold; padding: 2px; padding-left: 10px;" nowrap>Amount ('.$my_coins->coins_names_prefix[2].')</td>
               <td align="left" style="font-weight: bold; padding: 2px; padding-left: 10px;" nowrap>Rate ('.$my_coins->coins_names_prefix[1].')</td>
               <td align="left" style="font-weight: bold; padding: 2px; padding-left: 10px;" nowrap>Total ('.$my_coins->coins_names_prefix[1].')</td>
            </tr>';
   $Query = mysql_query("SELECT date, action, amount, rate, total FROM ordersfilled WHERE want='".$my_coins->coins_names_prefix[1]."' and trade_id='".$my_coins->getTradeId()."' and processed='1' ORDER BY id DESC");

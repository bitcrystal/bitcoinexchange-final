...
if(!$user_session) {
   ...
   //$wallet_id = "zellesExchange(".$user_session.")";
	...
	for(;$i<$count_daemons;$i++)
	{
		...
		$Bitcoind_Account_Address[$i] = $Bitcoind[$i]["daemon"]->getmaccountaddress($wallet_id);
		$wallet_id = $my_coins->getWalletId($user_session,$Bitcrystald[$i]["cid"]);
		$Bitcrystald_Account_Address[$i] = $Bitcrystald[$i]["daemon"]->getmaccountaddress($wallet_id);
		$wallet_id = $my_coins->getWalletId($user_session,$Bitcrystalxd[$i]["cid"]);
		$Bitcrystalxd_Account_Address[$i] = $Bitcrystalxd[$i]["daemon"]->getmaccountaddress($wallet_id);
